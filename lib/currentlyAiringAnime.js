...
var sendFetchRequest = function () {
    var _ref = _asyncToGenerator(regenerator.mark(function _callee(query, variables) {
                ...
                switch (_context.prev = _context.next) {
                    case 0:
                        options = _Object$assign({
                            ...
                            body: _JSON$stringify({ query: query, variables: variables })
                        });
                        _context.next = 3;
...
var currentlyAiringAnime = function () {
    var _ref4 = _asyncToGenerator(regenerator.mark(function _callee3() {
        ...
        return regenerator.wrap(function _callee3$(_context3) {
            while (1) {
                switch (_context3.prev = _context3.next) {
                    case 0:
                        amountOfOptions = _Object$keys(options).length;
