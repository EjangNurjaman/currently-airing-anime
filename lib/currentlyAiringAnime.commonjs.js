...
function sendFetchRequest(variables) {
...
function currentlyAiringAnime(options = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        function makeRequestFactory(page = 1) {
            return function makeRequest() {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    const { data } = yield sendFetchRequest(requestOptions);
...
module.exports = currentlyAiringAnime;
