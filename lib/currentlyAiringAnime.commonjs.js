...
var getAiringAnimeQuery = function (includeSchedule) { return "\n  query (\n    $page: Int\n    $season: MediaSeason\n\t\t$seasonYear: Int\n\t\t$malIdIn: [Int]\n\t\t$aniIdIn: [Int]\n    $sort: [MediaSort]\n    $status: MediaStatus\n  ) {\n    Page (page: $page) {\n      pageInfo {\n        total\n        currentPage\n        lastPage\n        hasNextPage\n        perPage\n      }\n\n      media(\n\t\t\t\tseason: $season,\n\t\t\t\tseasonYear: $seasonYear\n\t\t\t\tidMal_in: $malIdIn,\n\t\t\t\tid_in: $aniIdIn,\n        sort: $sort\n        status: $status\n\t\t\t) {\n        id\n        description\n        idMal\n        title {\n          romaji\n          native\n          english\n        }\n        studios {\n          edges {\n            node {\n              name\n            }\n          }\n\t\t\t\t}\n\t\t\t\tformat\n        genres\n        status\n        coverImage {\n          large\n        }\n        episodes\n        startDate {\n          year\n          month\n          day\n        }\n        nextAiringEpisode {\n          id\n          episode\n          airingAt\n          timeUntilAiring\n        }\n        " + (includeSchedule ? "\n          airingSchedule {\n            edges {\n              node {\n                episode\n                airingAt\n                timeUntilAiring\n              }\n            }\n          }\n        " : '') + "\n      }\n    }\n  }\n"; };
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch(apiEndpoint, options)];
                case 1:
                    response = _a.sent();
...
function makeRequestFactory(requestOptions) {
    ...
    return function makeRequest() {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, sendFetchRequest(getAiringAnimeQuery(includeSchedule), requestOptions)];
                    case 1:
                        data = (_a.sent()).data;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, makeRequestFactory({
                            page: 1,
...
exports.default = currentlyAiringAnime;
